...
public class CarSkeleton {
    ...
    public void runEngine(CarSkeleton carSkeleton){
        if(carSkeleton instanceof ElectricCar){
            ...
            System.out.println("The car engine is starting with electic. Per charge: "+ avgKmPerCharge + " battery size: "+ batterySize);
        }
            ...
            System.out.println("The car engine is starting with gaspowerred car. Per charge: "+ gasPoweredCar.getAverageKmPerLiter());
        }
        else{
